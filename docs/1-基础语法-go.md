...
> 爬取  <https://summer.ospp.ac.cn/2025/org/projectlist> 的全部项目，通过浏览器 F12 网络调试工具，找到对应的接口，然后编写爬虫程序
...
- 使用 .gitignore 忽略你爬取的文件

### Bonus

1. 爬取项目的所有申请书 PDF 文件
2. 并发爬取，同时给出加速比（加速比：相较于普通爬取，快了多少倍）
3. 将爬取的数据存入 SQLite 数据库，原生 SQL 或 ORM 都可以
